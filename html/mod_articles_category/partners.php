...
<div id="mod-player-<?php echo $module->id; ?>" class="mod-articles-cw mod-player-1 <?php echo $moduleclass_sfx; ?>" >
    ...
    foreach ($list as $item): ?>
     ...
     $partnerCountry = $extrafields->get('partnerCountry');
     $partnerStatus = $extrafields->get('partnerStatus');
     ?>
						<div class="col">
             ...
             $item->displayHits
                 ...
                 '</b>'; ?>
					          ...
					          <?php if ($partnerCountry): ?>
					          <div class="t-number">
					            <?php echo $partnerCountry; ?>
					          </div>
					          <?php endif; ?>
					          ...
					          <div class="t-name">
					            ...
					            <?php if ($partnerStatus): ?>
					            <div class="t-position">
					              <?php echo $partnerStatus; ?>
					            </div>
					            <?php endif; ?>
					          </div>
					        </div>
