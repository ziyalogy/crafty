...
?>
<div class="com-content-article detail-team-wrap project item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">

<div class="top-info" >
	<div   class="project_profile"></div>	
		<div class="container">
			<div class="row p-3">
				...
				<div class="col-12 col-lg-6 order-3 order-lg-2">
					<?php if ($params->get('access-view')) : ?>
						...
						<div class="statics-wrap">
							<h3><?php echo Jtext::_('TPL_STATICS') ;?></h3>

							<ul>
								<?php if($teamDate) :?>
									<li>
										<span><?php echo Jtext::_('TPL_BIRTHDAY') ;?></span>
										<small><?php echo $teamDate ;?></small>
									</li>
								<?php endif ;?>

								<?php if($teamNation) :?>
									<li>
										<span><?php echo Jtext::_('TPL_NATIONALITY') ;?></span>
										<small><?php echo $teamNation ;?></small>
									</li>
								<?php endif ;?>
								...
								<?php if($teamHeight) :?>
									<li>
										...
										<small><?php echo $teamHeight ;?></small>
									</li>
								<?php endif ;?>
								...
								<?php if($teamWeight) :?>
									<li>
										...
										<small><?php echo $teamWeight ;?></small>
									</li>
								<?php endif ;?>
								...
								<?php if($teamPlayed) :?>
									<li>
										...
										<small><?php echo $teamPlayed ;?></small>
									</li>
								<?php endif ;?>
